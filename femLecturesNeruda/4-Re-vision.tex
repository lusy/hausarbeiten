...
Anstatt exemplarisch noch ein Gedicht aus den \textit{Cien sonetos de amor} zu lesen, hab ich mich dafür entschieden noch auf "El Tigre" aus \textit{Los versos del capitán} einzugehen.
Ich konnte es mir nicht verkneifen, weil das Gedicht so krass ist.
Es kann gewisse nicht als "typischer" Vertreter für das gesamte Band stehen, da, wie bereits erwähnt, die Gedichte dadrin so heterogen sind.

Überhaupt der gesamte Unterteil? "El deseo", in dem die drei Gedichte nach Tieren benannt sind, ist sehr problematisch. %TODO Verify da sind nur die 3 drin.
Die bereits in \textit{Veinte poemas de amor} budding Tendenz, das lyrische Du nicht als Person, sondern als einzelne Körperteile zu begreifen, wird hier zugespitzt und noch stärker sexualisiert.
...
Das lyrische Ich wendet sich/schwärmt von \textit{caderas} und \textit{pies}, von \textit{un cráter, una rosa/de fuego humedecido}—seine Umschreibung für die weiblichen Genitalien.
...
Man könnte "El tigre" mit 3 Wörtern beschreiben, diese wären dann aber nicht "universelle menschliche Gefühle", sondern "Glorifizierung von rape culture".


In der \textit{Antología poética}, die 1983 vom spanischen Poet und Kritiker (und enger? Freund Nerudas) Rafael Alberti für den Madrider Verlag Espasa-Calpe kuratiert wurde, fehlt "El tigre".
Alberti hat, nach eigenen Worten, die schönsten Gedichte für dieses Sammelband ausgewählt, und er fand anscheinend auch (obwohl die Auswahl schwer war), dass "El tigre" nicht unbedingt dazu gehört.
