...
diese wird von ihm definiert als ``those instances of deviation from the norms of either language which occur in the speech of bilinguals as a result of their familiarity with more than one language'' \cite{Weinreich79}\footnote{Erste Veröffentlichung dieser Schrift erfolgt bereits in 1953.}.
...
\cite{Ellis06} führt noch aus, dass wenn aus den oben genannten Gründen Transfer derselben Konstruktion öfters passiert, diese Konstruktion einen Prozess der Einschleifung (entrenchment) durchläuft und sich als dauerhafte Repräsentation etabliert.

Das Phänomen der Übergeneralisierung wird schon durch \cite{Taylor75} kognitiv linguistisch begründet.
...
(3) die Lernende macht bereits kreativen Gebrauch von der zu erlernenden Sprache; sie setzt bereits erworbenes Wissen aktiv um.
...
nämlich das Zurückgreifen auf schon vorhandenes Wissen, um die Aneignung neuen Wissens zu ermöglichen und zu vereinfachen.
