...
Están dibujadxs muchxs niñxs, es, después de todo, un libro infantil.
Todxs....
tienen nombres! : Horacio (p.17), Yolanda, Inés, Zoilo y Ubaldo (p.16), Cholita (p.21)
...
* ``Independencia Política e Independencia Económica'' (p.30-31)
* ``Caminos'' (p.50), 
* ``Día de la Recuperación Nacional'' (p.48)
