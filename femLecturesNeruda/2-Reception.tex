\section{Nerudas Liebeslyrik: die etablierte Rezeption}
...
In der Sitzung, die sich der Liebeslyrik widmete, sprach eine Kommilitonin von ``universellem menschlichem fleischlichem Begehren''.
Unter den mehr als 30 Seminar-Teilnehmenden scheinte niemand diese Aussage problematisch zu finden bis auf die Professorin und 2-3 Kommilitoninnen (mich inklusive), die etwas älter als das Durchschnittsalter von 20 waren.
...
Guillermo Araya betrachtet die Frau in den Gedichten als ``homenajeada''~\cite{Araya1982} und den Raum, den sie in den Text annimmt, als privilegiert, da sie ``the object of the male speaker's unrelenting, adoring gaze'' ist~\cite{Duncan1992}.
