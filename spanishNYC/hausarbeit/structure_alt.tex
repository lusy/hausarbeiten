...
\usepackage{rotating} % allows for rotating images
...
%\usepackage{caption} % following 2 needed for subfigures / comment out if subfig on
%\usepackage{subcaption}
\usepackage{listings}
\usepackage{color}
%\usepackage{natbib}
\usepackage[style=mla, backend=biber, sortlocale=de_DE, citestyle=authoryear, showmedium=false]{biblatex}
