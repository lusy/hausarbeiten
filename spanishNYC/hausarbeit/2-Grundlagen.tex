...
%Stil
Der Begriff Sozioindexikalität ist eng an den Begriff ``Stil'' gekoppelt und in mehreren Zusammenhänge/für mehrere Zwecke können Beide synonym verwendet werden.
...
``Stil'' ist eigentlich viel breiter gefasst: dadrunter werden nicht nur die gewählten linguistischen Merkmale gemeint, sondern diese werden mit weiteren stilistischen Systemen kombiniert (z.B. Kleidung etc.)
Zugrunde der stilistischen Praxen (hierunter sind sowohl die Produktion als auch die Interpretation von Stils gemeint) liegen Ideologien, erläutert Eckert.
