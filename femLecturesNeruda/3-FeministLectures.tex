...
Eine Elite aus westlichen, weißen, oft konservative ältere Männer versucht ihre priviligierte Stellung dadurch zu sichern, indem sie hier eine Hierarchie herstellt, einen Mechanismus, der aufzeigen sollte, was ``gute'' und was ``schlechte'' Literatur ist~\autocite{North2013}.%vlt bisschen zu drastisch formuliert?

%und diese als "objektiv" verkaufen
Und dieser funktioniert natürlich aufgrund eines komplett ``objektiven'' Kriteriums: des ``inherenten'' ästhetischen Werts der Werke~\autocite{North2013}.
