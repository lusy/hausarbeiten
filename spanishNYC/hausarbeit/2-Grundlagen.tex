...
Primäre Sozioindexikalität ist ...
``A first-order index simply indexes membership in a population.''

%sekundäre Indexikalität
Jedoch ist für Penelope Eckert diese Kategoriezugehörigkeit nicht statisch.
...
Die bewusste Wahl und Aneignung (sprachlicher) Elemente und der damit assoziirten Werte und Eigenschaften werden wir als sekundäre Sozioindexikalität bezeichnen.
...
Dieser Begriff ist eng am Begriff ``Stil'' gekoppelt und in mehreren Zusammenhänge/für mehrere Zwecke können Beide synonym verwendet werden.
