\section{Llengua i traducció. Lectura lingüística}
...
Tenim tota la història explicada des de la perspectiva de la filla i encara una instància narrativa omniscient.
...
L'estil directe al llarg del llibre no està marcat de manera gràfica en cap lloc; el discurs s'assembla més a un corrent de consciència, que de nou afirma la proximitat amb la filla.
És curiós també, que el nom de la filla no es menciona ni una sola vegada, un fet que crea atmosfera d'universalitat.
...
%traducció
En el seu treball sobre l'obra de Najat El Hachmi Vidal Claramonte destaca la traducció com a element bàsic de ``L'últim patriarca''.
...
Tenim per a això exemples diversos:
la filla que tradueix els preus dels aliments a la seva mare, no només canviant la llengua, sinó també convertint les pessetes en duros;
la filla que ajuda la seva mare embarassada a parlar amb la ginecòloga:
\begin{quote}
...
Seguint el tema de la traducció, cal notar que
...
Així doncs, el diccionari marcaria també els límits de l'univers de la filla.
...
El Hachmi assenyala que si no parlem de la violència, ens convertim en els seus còmplices~\autocite{HaAM2011}.
...
Les lectures del diccionari per part de la filla són el primer pas per estar en control de la situació, destaca ella.
...
Sobretot tres obres semblen bastant importants per a la novel·la, ja que es mencionen per raons diferents repetidament: ``La plaça del diamant'' de Mercè Rodoreda, ``El petit princep'' d'Antoine de Saint-Exupéry i ``The House on Mango Street'' de Sandra Cisneros.
...
``La plaça del diamant'' té un paper important pel personatge de la mare.
La seva protagonista principal, la Colometa, serveix com a descripció de la mare, com a comparació amb algú familiar per a la majoria de les lectores:
...
I, de fet, trobarem trets similars entre les dues (a part de netejar els excrements de coloms): el patiment en silenci, la submissió femenina davant un marit abusiu, la moral doble a què estan sotmeses totes dues.
A més a més, aquestes línies contenen les poques vegades que el nom de la mare es menciona en absolut:
...
Demés, les referències de Rodoreda també ens fan sentir la proximitat entre la protagonista i la cultura catalana.
