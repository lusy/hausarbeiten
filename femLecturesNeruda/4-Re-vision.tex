...
Auch wenn es schwer fällt, alle Texte in \textit{Los versos del capitán} unter einem Gesamteindruck zusammen zu fassen;
...
es auf dem ersten Blick als ``schön'' und ``romantisch'' (wie viele der anderen Liebesgedichte Nerudas) gelesen werden könnte, %TODO erklären warum schön und romantisch in Gänsefüßchen stehen, wenn ich das so behalte; das Problem ist, beide Begriffe sind so hingeklatscht etwas lapidär und ungenau
...
Dies wird auf Basis von vielen Konstrasten deutlich. %noch ein beispiel für die kontraste?
Der männliche Sprecher kann ohne Nahrung (``quitame el pan'') oder Luft (``quitame el aire'') überleben, aber nicht ohne das Lächeln.
Umständlich/weitschweifig wird die Bedeutung und Schönheit dieses Lächeln beschrieben:
