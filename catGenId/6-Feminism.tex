...
Perquè si tothom et diu contínuament que siguis així o d'aquesta altra manera, al final també acabes creient-lo.
I les atribucions són, naturalment, no de qualitats vinculades amb control i poder, sinó tot el contrari: de qualitats submises, suaus, agradables, no poderoses i quals no canvien el món.
...
Llavors, el patriarcat tracta les dones com una propietat dels homes, com si la seva única funció fos satisfer les seves necessitats, ser una combinació d'amant submissa i dona per fer feines.
...
I els càstigs socials són molt forts per aquelles que no aconsegueixin protegir-se o, per no esmentar, aquelles que si li agradi tenir relacions sexuals.
...
Ella és la persona amb la ``capa de \textit{supermana}''~\autocite[191]{ElHachmi2008} qui salva la família en ocasions múltiples.
