...
Sowohl in germanischen als auch in romanischen Sprachen wird das Topik\footnote{
Mit ``Topik'' wird hier die Einheit einer sprachlichen Äußerung bezeichnet, über die was ausgesagt wird. Die Aussage, die über das Topik getroffen wird, wird dann Kommentar genannt.}
einer Äußerung üblicherweise durch Auslagerung einer Phrase realisiert, die dann im Satz wieder aufgegriffen wird \cite[S.1]{Valenzuela05}.
...
Zusätzlich zu jeder der beiden Probandinnengruppen wurde jeweils eine Kontrollgruppe von Muttersprachlerinnen befragt \cite[S.4]{Valenzuela05}.
