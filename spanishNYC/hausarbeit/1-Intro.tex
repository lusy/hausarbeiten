...
Das Ziel dieser Arbeit ist eine Analyse der Code-Switches zwischen dem Spanischen und dem Englischen in Artikeln der Zeitschrift ``Siempre mujer'' aus einer soziolinguistischen Perspektive.
...
z.B. wenn es um technische Begriffe geht oder um Idiome, für die keine genaue Übersetzung ins Spanische existiert.
...
Es wäre weiterhin interessant zu untersuchen, in wie fern ins Englische geswitcht wird, da diese Sprache als prestigeträchtiger wahrgenommen wird oder weil dadurch ein bestimmter Lifestyle(?) inszeniert wird, wodurch dann auch versucht wird bestimmte Produkte zu verkaufen.
...
Kapitel 2 gibt einen Überblick über die theoretischen Grundlagen, deren ich mich für die Analyse bediene.
