...
%spannend(syn)/aufschlussreich/notwendig/wichtig/relevant.
...
Abschließend lässt es sich sagen, dass obwohl Publikationen wie \textit{Siempre Mujer} eine Atmosphäre der Komplizenschaft zu erzeugen suchen (z.B. durch ganz bewusste Wahl der eingesetzten sprachlichen Codes), sie alles andere als ``schwesterlich'' sind.
...
% würde ich eigentlich weg lassen
...
% mh.. das macht ne ganz neue Dimension auf, die die Leserinnen zugleich als nicht kompetent genug der Englischen Sprache inszeniert und entsprechende Stereotypen hervorruft
